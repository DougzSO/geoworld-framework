...
- [ ] **Campaign #1** — `concentration=20` (Dirichlet, SA-2), ainda não testado formalmente apesar de já ter evidência de swing 2.5x (`sensitivity_analyzer.py:376`). → [BACKLOG.md, Campaign table row 1](BACKLOG.md)
